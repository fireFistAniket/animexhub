...
exports.tmdbApi = exports.fastify = exports.redis = void 0;
...
(async () => {
    ...
    await exports.fastify.register(cors_1.default, {
        origin: '*',
        methods: 'GET',
    });
    if (process.env.NODE_ENV === 'DEMO') {
        ...
        exports.fastify.addHook('onRequest', async (request, reply) => {
            const ip = request.ip;
        ...
        exports.fastify.post('/apidemo', async (request, reply) => {
            const { ip } = request;
            // check if the requester ip has a session (temporary access)
            const session = map.get(ip);
            if (session)
        ...
        exports.fastify.get('/apidemo', async (_, reply) => {
            try {
    ...
    await exports.fastify.register(books_1.default, { prefix: '/books' });
    await exports.fastify.register(anime_1.default, { prefix: '/anime' });
    await exports.fastify.register(manga_1.default, { prefix: '/manga' });
    //await fastify.register(comics, { prefix: '/comics' });
    await exports.fastify.register(light_novels_1.default, { prefix: '/light-novels' });
    await exports.fastify.register(movies_1.default, { prefix: '/movies' });
    await exports.fastify.register(meta_1.default, { prefix: '/meta' });
    await exports.fastify.register(news_1.default, { prefix: '/news' });
    await exports.fastify.register(utils_1.default, { prefix: '/utils' });
    try {
        exports.fastify.get('/', (_, rp) => {
            rp.status(200).send(`Welcome to consumet api! 🎉 \n${process.env.NODE_ENV === 'DEMO'
                ? 'This is a demo of the api. You should only use this for testing purposes.'
                : ''}`);
        });
        exports.fastify.get('*', (request, reply) => {
